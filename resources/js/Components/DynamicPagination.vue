<template>
  <div v-if="totalPages > 1" class="mt-6 flex justify-center items-center space-x-1 flex-wrap max-w-md mx-auto">
    ...
    <button
      ...
      class="px-2 py-1 text-sm bg-gray-400 text-gray-900 rounded-l-md disabled:opacity-50"
    >
      First
    </button>
    ...
    <button
      ...
      :disabled="currentPage === 1"
      class="px-2 py-1 text-sm bg-gray-400 text-gray-900 disabled:opacity-50"
    >
      Prev
    </button>
    ...
    <template v-for="(page, index) in displayedPageNumbers" :key="index">
      ...
      <button
        ...
        :class="{'bg-blue-500 text-white': page === currentPage, 'bg-gray-400 text-gray-900': page !== currentPage}"
    ...
    <button
      ...
      :disabled="currentPage === totalPages"
      class="px-2 py-1 text-sm bg-gray-400 text-gray-900 rounded-r-md disabled:opacity-50"
    >
      Last
    </button>
  </div>
